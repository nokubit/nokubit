...
uint256 SignatureHash(const CScript& scriptCode, const CTransaction& txTo, unsigned int nIn, int nHashType, const asset_tag::AssetAmount& amount, SigVersion sigversion, const PrecomputedTransactionData* cache)
{
